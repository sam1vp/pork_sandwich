...
begin
  ...
  Jeweler::Tasks.new do |gemspec|
    ...
    gemspec.files = FileList['lib/pork_sandwich/*.rb', 'lib/pork_sandwich.rb', 'lib/table_classes/*.rb', 'generators/pork_sandwich_migration/*.rb', 'generators/pork_sandwich_migration/templates/*.rb', 'Rakefile', 'README', 'VERSION' ]
